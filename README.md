...
oldbalanceDest - налична сума преди транзакцията;
newbalanceDest - налична сума след транзакцията;
...
EDIT: Дърво на решенията само с променливите от модела на логистичната регресия намалява точността на модела драстично. Получаваме 

             0     1
       0 29969    33
       1     0     0
       
,т.е. не познава дори 1 измама от 33.
